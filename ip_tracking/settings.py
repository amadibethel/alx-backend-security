...
ALLOWED_HOSTS = ['*']  # Update with your server domain/IP in production
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # optional, create templates/ folder
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Database (example: SQLite for development)
DATABASES = {
    'default': {
